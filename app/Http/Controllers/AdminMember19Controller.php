<?php namespace App\Http\Controllers;
	...
	class AdminMember19Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Provinsi","name"=>"id_provinsi","join"=>"master_provinsi,nama"];
			$this->col[] = ["label"=>"Kota","name"=>"id_kota","join"=>"master_kota,nama"];
			...
			$this->form[] = ['label'=>'Provinsi','name'=>'id_provinsi','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'master_provinsi,nama'];
			$this->form[] = ['label'=>'Kota','name'=>'id_kota','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'master_kota,nama'];
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:member','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			$this->form[] = ['label'=>'Validation Code','name'=>'validation_code','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Provinsi","name"=>"id_provinsi","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"provinsi,nama"];
			//$this->form[] = ["label"=>"Kota","name"=>"id_kota","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"kota,nama"];
			...
			//$this->form[] = ["label"=>"Validation Code","name"=>"validation_code","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
