<?php namespace App\Http\Controllers;
	...
	class AdminMember16Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Provinsi','name'=>'id_provinsi','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Kota','name'=>'id_kota','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'provinsi,nama'];
