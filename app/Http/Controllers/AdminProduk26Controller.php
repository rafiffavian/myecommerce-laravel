<?php namespace App\Http\Controllers;
	...
	class AdminProduk26Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Kategori","name"=>"id_kategori","join"=>"kategori_produk,name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Kategori','name'=>'id_kategori','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'kategori_produk,name'];
			...
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'hidden','value'=>1,'validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Kategori","name"=>"id_kategori","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"kategori,id"];
