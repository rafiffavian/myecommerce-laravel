<?php namespace App\Http\Controllers;
	...
	class AdminProduk25Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Kategori","name"=>"id_kategori","join"=>"kategori_produk,id"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Kategori','name'=>'id_kategori','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'kategori_produk,id'];
